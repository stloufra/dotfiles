...
configure_git(){
    ...
    if [[ ! -f "$key_path" ]]; then
        ...
        ssh-keygen -t ed25519 -C "frantisek.stloukal@cern.ch" -f "$key_path" -N ""
        echo
    else
    ...
    while true; do
        read -rp "Have you added this key to your Git account? [y/n] " yn
        case $yn in
            [Yy]* ) echo "Continuing..."; break;;
            [Nn]* ) echo "Please add the key first, then rerun this function."; return 1;;
...
echo "================================================================"
while true; do
    read -p "Do you want to install cadnac?[y/n]" yn 
    case $yn in
        [Yy]* ) ./install_cadna.sh;break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
done
...
echo "================================================================"
while true; do
    read -p "Do you want to install promise?[y/n]" yn 
    case $yn in
        [Yy]* ) ./install_promise.sh;break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
done
echo "================================================================"
while true; do
    read -p "Do you want to install mg5?[y/n]" yn 
    case $yn in
        [Yy]* ) ./install_mg5.sh;break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
done
